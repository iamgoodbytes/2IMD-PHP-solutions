    ...
    <div class="content__left">
      <section class="navigation">
        ...
        <div class="navigation__list">
          <div class="navigation__list__header" role="button" data-toggle="collapse" href="#yourMusic" aria-expanded="true" aria-controls="yourMusic">Your Music
          </div>
      ...
      <section class="playing">
        <div class="playing__art"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/7022/cputh.jpg" alt="Album Art" /></div>
        ...
        <div class="artist__header">
          <div class="artist__info">
            <?php foreach ($result = $conn->query($sql) as $row) : ?>
              <div class="profile__img"><img src="<?php echo $row["cover"]; ?>" alt="Artist name here" /></div>
              <div class="artist__info__meta">
                <div class="artist__info__type">Artist</div>
                <div class="artist__info__name"><?php echo $row["name"]; ?></div>
              <?php endforeach; ?>
          ...
          <div class="artist__navigation">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#artist-overview" aria-controls="artist-overview" role="tab" data-toggle="tab">Overview</a></li>
                    ...
                    <?php foreach ($result = $conn->query($sqlAlbums) as $row) : ?>
                      <div class="album__info">
                        ...
                        <div class="album__info__meta">
                          ...
                          <div class="album__actions"><button class="button-light save">Save</button><button class="button-light more"><i class="ion-ios-more"></i></button>
                          </div>
                        </div>
                      </div>
                    <?php endforeach; ?>
